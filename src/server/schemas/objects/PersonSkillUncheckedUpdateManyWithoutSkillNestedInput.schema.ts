...
const Schema: z.ZodType<Prisma.PersonSkillUncheckedUpdateManyWithoutSkillNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonSkillUncheckedUpdateManyWithoutSkillNestedInputObjectSchema =
  Schema;
