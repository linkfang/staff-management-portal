...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithoutPersonsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ProjectUpdateManyWithWhereWithoutPersonsInputObjectSchema),
        z
          .lazy(() => ProjectUpdateManyWithWhereWithoutPersonsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ProjectUpdateManyWithoutPersonsNestedInputObjectSchema = Schema;
