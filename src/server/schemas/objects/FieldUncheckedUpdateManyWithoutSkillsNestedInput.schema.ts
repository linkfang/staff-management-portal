...
const Schema: z.ZodType<Prisma.FieldUncheckedUpdateManyWithoutSkillsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => FieldUpsertWithWhereUniqueWithoutSkillsInputObjectSchema,
          ),
          z
            .lazy(
              () => FieldUpsertWithWhereUniqueWithoutSkillsInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => FieldUpdateWithWhereUniqueWithoutSkillsInputObjectSchema,
          ),
          z
            .lazy(
              () => FieldUpdateWithWhereUniqueWithoutSkillsInputObjectSchema,
...
export const FieldUncheckedUpdateManyWithoutSkillsNestedInputObjectSchema =
  Schema;
