...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithoutFieldsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ProjectUpdateManyWithWhereWithoutFieldsInputObjectSchema),
        z
          .lazy(() => ProjectUpdateManyWithWhereWithoutFieldsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ProjectUpdateManyWithoutFieldsNestedInputObjectSchema = Schema;
