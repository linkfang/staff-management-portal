...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithoutSkillsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ProjectUpdateManyWithWhereWithoutSkillsInputObjectSchema),
        z
          .lazy(() => ProjectUpdateManyWithWhereWithoutSkillsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ProjectUpdateManyWithoutSkillsNestedInputObjectSchema = Schema;
