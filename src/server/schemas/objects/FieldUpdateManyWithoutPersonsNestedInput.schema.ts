...
const Schema: z.ZodType<Prisma.FieldUpdateManyWithoutPersonsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => FieldUpsertWithWhereUniqueWithoutPersonsInputObjectSchema),
        z
          .lazy(() => FieldUpsertWithWhereUniqueWithoutPersonsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => FieldUpdateWithWhereUniqueWithoutPersonsInputObjectSchema),
        z
          .lazy(() => FieldUpdateWithWhereUniqueWithoutPersonsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const FieldUpdateManyWithoutPersonsNestedInputObjectSchema = Schema;
