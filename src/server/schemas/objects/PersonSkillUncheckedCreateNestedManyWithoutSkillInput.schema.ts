...
const Schema: z.ZodType<Prisma.PersonSkillUncheckedCreateNestedManyWithoutSkillInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonSkillUncheckedCreateNestedManyWithoutSkillInputObjectSchema =
  Schema;
