...
const Schema: z.ZodType<Prisma.PersonCreateNestedManyWithoutExpertiseInput> = z
  .object({
    create: z
      .union([
...
export const PersonCreateNestedManyWithoutExpertiseInputObjectSchema = Schema;
