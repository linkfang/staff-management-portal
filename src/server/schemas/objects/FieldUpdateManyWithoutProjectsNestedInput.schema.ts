...
const Schema: z.ZodType<Prisma.FieldUpdateManyWithoutProjectsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => FieldUpdateManyWithWhereWithoutProjectsInputObjectSchema),
        z
          .lazy(() => FieldUpdateManyWithWhereWithoutProjectsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const FieldUpdateManyWithoutProjectsNestedInputObjectSchema = Schema;
