...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithWhereWithoutPersonsInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => ProjectUncheckedUpdateManyWithoutProjectsInputObjectSchema,
        ),
      ]),
    })
    .strict();

export const ProjectUpdateManyWithWhereWithoutPersonsInputObjectSchema = Schema;
