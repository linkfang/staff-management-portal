...
const Schema: z.ZodType<Prisma.PersonUpdateManyWithoutExpertiseNestedInput> = z
  .object({
    create: z
      .union([
...
export const PersonUpdateManyWithoutExpertiseNestedInputObjectSchema = Schema;
