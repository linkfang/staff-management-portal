...
const Schema: z.ZodType<Prisma.SkillUpdateManyWithoutFieldNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => SkillUncheckedCreateWithoutFieldInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => SkillCreateOrConnectWithoutFieldInputObjectSchema),
        z.lazy(() => SkillCreateOrConnectWithoutFieldInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const SkillUpdateManyWithoutFieldNestedInputObjectSchema = Schema;
