...
const Schema: z.ZodType<Prisma.PersonSkillUpdateManyWithoutPersonNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonSkillUpdateManyWithoutPersonNestedInputObjectSchema = Schema;
