...
const Schema: z.ZodType<Prisma.PersonSkillCreateNestedManyWithoutPersonInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonSkillCreateNestedManyWithoutPersonInputObjectSchema = Schema;
