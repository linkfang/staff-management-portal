...
const Schema: z.ZodType<Prisma.PersonUpdateManyWithWhereWithoutProjectsInput> =
  z
    .object({
...
export const PersonUpdateManyWithWhereWithoutProjectsInputObjectSchema = Schema;
