...
const Schema: z.ZodType<Prisma.FieldUncheckedCreateNestedManyWithoutSkillsInput> =
  z
    .object({
      create: z
        .union([
...
export const FieldUncheckedCreateNestedManyWithoutSkillsInputObjectSchema =
  Schema;
