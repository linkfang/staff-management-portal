...
const Schema: z.ZodType<Prisma.SkillUpdateManyWithoutProjectNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => SkillUpsertWithWhereUniqueWithoutProjectInputObjectSchema),
        z
          .lazy(() => SkillUpsertWithWhereUniqueWithoutProjectInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => SkillUpdateWithWhereUniqueWithoutProjectInputObjectSchema),
        z
          .lazy(() => SkillUpdateWithWhereUniqueWithoutProjectInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const SkillUpdateManyWithoutProjectNestedInputObjectSchema = Schema;
