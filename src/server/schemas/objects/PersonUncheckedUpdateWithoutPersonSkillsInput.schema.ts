...
const Schema: z.ZodType<Prisma.PersonUncheckedUpdateWithoutPersonSkillsInput> =
  z
    .object({
      id: z
        .union([
      ...
      expertise: z
        .lazy(
          () => FieldUncheckedUpdateManyWithoutPersonsNestedInputObjectSchema,
        )
        .optional(),
      projects: z
        .lazy(
...
export const PersonUncheckedUpdateWithoutPersonSkillsInputObjectSchema = Schema;
