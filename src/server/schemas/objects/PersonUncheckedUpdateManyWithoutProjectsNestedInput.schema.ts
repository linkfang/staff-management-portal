...
const Schema: z.ZodType<Prisma.PersonUncheckedUpdateManyWithoutProjectsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PersonUpdateManyWithWhereWithoutProjectsInputObjectSchema,
          ),
          z
            .lazy(
              () => PersonUpdateManyWithWhereWithoutProjectsInputObjectSchema,
...
export const PersonUncheckedUpdateManyWithoutProjectsNestedInputObjectSchema =
  Schema;
