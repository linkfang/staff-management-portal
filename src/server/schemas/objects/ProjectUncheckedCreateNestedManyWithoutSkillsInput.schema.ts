...
const Schema: z.ZodType<Prisma.ProjectUncheckedCreateNestedManyWithoutSkillsInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectUncheckedCreateNestedManyWithoutSkillsInputObjectSchema =
  Schema;
