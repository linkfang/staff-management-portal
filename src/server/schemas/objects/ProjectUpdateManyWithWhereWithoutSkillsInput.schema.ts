...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithWhereWithoutSkillsInput> = z
  .object({
...
export const ProjectUpdateManyWithWhereWithoutSkillsInputObjectSchema = Schema;
